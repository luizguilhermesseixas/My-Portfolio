...
export default function ContactPage() {
  ...
  const contactInfos = [
    {
      icon: <MailIcon className="w-5 h-5 text-primary-500" />,
      label: "luizseixasusa@gmail.com",
      href: "mailto:luizseixasusa@gmail.com",
    },
    {
      icon: <PhoneIcon className="w-5 h-5 text-primary-500" />,
      label: "+1 645 237-9799",
      href: "tel:+16452379799",
    },
    {
      icon: <MapIcon className="w-5 h-5 text-primary-500" />,
      label: "Miami, FL, USA",
      href: null,
    },
    {
    ...
    <section className="max-w-5xl mx-auto py-16 px-2 sm:px-4">
      <div className="flex flex-col items-center">
        <div className="w-full max-w-xl flex items-center mb-8 justify-center md:justify-start">
          ...
          <LionIcon className="w-14 h-14 md:w-20 md:h-20 text-primary-500 ml-4 transition-transform duration-300 hover:-translate-y-2 hover:rotate-6" />
        </div>
